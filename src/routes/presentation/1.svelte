		...
		<svelte:fragment slot="slide-content">
			<ul>
				...
				<li>
					...
					often see temperatures of -40°C to -60°C in the air, and temperatures of 50°C on the
					ground.
				</li>
			</ul>
		</svelte:fragment>
...
<style>
	...
	@font-face {
		...
		src: local(''), url('/fonts/work-sans-v16-latin-700.eot?#iefix') format('embedded-opentype'),
			/* IE6-IE8 */ url('/fonts/work-sans-v16-latin-700.woff2') format('woff2'),
			/* Super Modern Browsers */ url('/fonts/work-sans-v16-latin-700.woff') format('woff'),
			/* Modern Browsers */ url('/fonts/work-sans-v16-latin-700.ttf') format('truetype'),
			/* Safari, Android, iOS */ url('/fonts/work-sans-v16-latin-700.svg#WorkSans') format('svg'); /* Legacy iOS */
	}
	...
	@font-face {
		...
		src: local(''), url('/fonts/work-sans-v16-latin-900.eot?#iefix') format('embedded-opentype'),
			/* IE6-IE8 */ url('/fonts/work-sans-v16-latin-900.woff2') format('woff2'),
			/* Super Modern Browsers */ url('/fonts/work-sans-v16-latin-900.woff') format('woff'),
			/* Modern Browsers */ url('/fonts/work-sans-v16-latin-900.ttf') format('truetype'),
			/* Safari, Android, iOS */ url('/fonts/work-sans-v16-latin-900.svg#WorkSans') format('svg'); /* Legacy iOS */
	}
